module pancake::smart_chef {
    ...
    #[view]
    public fun get_resource_address(): address acquires SmartChefMetadata {
        let metadata = borrow_global_mut<SmartChefMetadata>(RESOURCE_ACCOUNT);
        account::get_signer_capability_address(&metadata.signer_cap)
    }
    ...
    public entry fun create_pool(
        ...
        pool_limit_per_user: u64,
        seconds_for_user_limit: u64
    ) acquires SmartChefMetadata, Tabel {
    ...
    #[view]
    public fun create_user_info_address(owner: address,  pool_object: Object<PoolInfo>, id: u64):address{
        let seed = vector[];
    ...
    public entry fun deposit(
        ...
        id: u64,
        amount: u64
    ) acquires PoolInfo, UserInfo, Tabel, SmartChefMetadata {
